...
if mode == "1. Wind Simulator":
    ...
    if wind_profile == "Constant Velocity Wind":
        ...
        calc_v_r_const = 0.0
        calc_m_slope = st.sidebar.number_input("Acceleration Slope", value=default_params['m_slope'], step=10, key='m_slope')
        calc_v_r_max = st.sidebar.number_input("Maximum Velocity", value=default_params['v_r_max'], step=50, key='v_r_max')
